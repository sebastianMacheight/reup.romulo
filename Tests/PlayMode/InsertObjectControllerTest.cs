...
namespace ReupVirtualTwinTests.controllers
{
   public class InsertObjectControllerTest : MonoBehaviour
   {
       ...
       ModelInfoManagerSpy modelInfoManagerSpy;
       ...
       public void SetUp()
       {
           ...
           modelInfoManagerSpy = new ModelInfoManagerSpy();
           ...
           controller = new InsertObjectController(mediatorSpy, meshDownloaderSpy, insertPosition, modelInfoManagerSpy);
       ...
       private class MeshDownloaderSpy : IMeshDownloader
       {
        ...
        {
            private int objectsAddedToBuilding = 0;
