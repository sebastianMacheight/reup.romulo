namespace ReupVirtualTwin.enums
{
    public class WebMessageType
    {
        ...
        public const string activatePositionTransform = "[Transform Objects] Activate Position Transform";
        public const string activatePositionTransformSuccess = "[Transform Objects] Activate Position Transform Success";
        public const string activateRotationTransform = "[Transform Objects] Activate Rotation Transform";
