...
namespace ReupVirtualTwin.helpers
{
    ...
    public class SerializeMesh : MonoBehaviour
    {
        ...
        [HideInInspector][SerializeField] Vector4[] tangents;
        [HideInInspector][SerializeField] Bounds bounds;
        [HideInInspector][SerializeField] public bool serialized = false;
    ...
    class SerializeMeshEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            //if (obj.serialized)
            //{
            //    GUILayout.Label("The mesh is serialized");
            //}
            //else
            //{
            //    GUILayout.Label("The mesh is NOT serialized yet");
            //}
